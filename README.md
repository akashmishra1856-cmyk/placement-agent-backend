...
Clone the repo and create a virtual environment: python -m venv venv then venv\Scripts\activate

Install dependencies: pip install -r requirements.txt

Create a .env file in the project root with: GEMINI_API_KEY=your_gemini_api_key_here
